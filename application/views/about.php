  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="<?php echo site_url();?>/home/2">About</a><span class="sr-only">(current)</span></li>
...
<br>
      ...
      <br>
            <div class="jumbotron">
                <br><center>
                <h1 style="font-size:420%;">Halaman About</h1>
                <h2> Tugas CodeIgniter Menambahkan Home,News,Contact dan About</h2>
                <br></center>
            </div></div>
